    ...
    >
      {list !== 0 &&
        list.map((trajet) => {
          ...
          const displayDate = date.day.toString().padStart(2,"0") + "/" + date.month.toString().padStart(2,"0") + "/" + date.year + " " + date.hour.toString().padStart(2,"0") + ":" + date.minute.toString().padStart(2,"0")
          return (
            <React.Fragment key={trajet.cleaned_section._id.$oid}>
              <ListItem key={trajet.cleaned_section._id.$oid}>
                <ListItemButton
